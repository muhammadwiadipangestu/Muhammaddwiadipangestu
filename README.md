...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        .art-tags { display: flex; flex-wrap: wrap; gap: 8px; margin-top: 15px; }
        .art-tag { background: var(--bg-secondary); border: 1px solid var(--border-gray); font-size: 12px; padding: 5px 12px; border-radius: 20px; font-weight: 500; color: var(--text-dark); }
        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <p class="text-content">
                    Halo! Saya adalah pelajar yang lahir dan tumbuh di Pekanbaru. Saya memiliki keyakinan bahwa pemikiran logis dan kreativitas visual bisa berjalan beriringan. Di satu sisi, saya sangat menikmati tantangan memecahkan soal-soal eksakta seperti fisika dan geometri. Di sisi lain, saya gemar menuangkan imajinasi melalui *digital editing* dan penciptaan konten.
                </p>
                <div class="info-list">
            ...
            <div class="card">
                ...
                <p class="text-content">Pendidikan adalah fondasi utama saya untuk meraih masa depan di bidang ilmu pengetahuan alam dan teknologi.</p>
                
                <div class="timeline">
                    <div class="timeline-item">
                        <div class="timeline-date">Saat Ini (Kelas 9)</div>
                        <div class="timeline-title">SMP IT Mutiara Global</div>
                        <div class="timeline-desc">Fokus pada penyelesaian studi menengah pertama dengan nilai terbaik, mengasah logika dasar, dan aktif dalam keorganisasian sekolah.</div>
                    </div>
                    <div class="timeline-item">
                        <div class="timeline-date">Target Masa Depan</div>
                        <div class="timeline-title">MAN 3</div>
                        <div class="timeline-desc">Melanjutkan pendidikan menengah atas dengan peminatan bidang sains. Bertujuan untuk memperdalam ilmu eksakta sebagai persiapan menuju pendidikan tinggi.</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <p class="text-content">
                    Dipercaya sebagai <strong>Kepala OSIS Divisi Sosial</strong> untuk masa bakti 2025/2026. Peran ini melatih saya untuk menjadi pribadi yang lebih berempati, terorganisir, dan mampu memimpin kerja sama tim.
                </p>
                <div style="background: var(--bg-secondary); padding: 15px; border-radius: 12px; border-left: 4px solid var(--accent-blue); margin-top: 15px;">
                    <strong style="font-size: 14px; color: var(--text-dark);">Fokus Divisi Sosial:</strong>
                    <p style="font-size: 13px; color: var(--text-light); margin-top: 5px;">Menciptakan lingkungan sekolah yang bersolidaritas tinggi melalui program-program yang menumbuhkan kepedulian antar sesama siswa dan masyarakat sekitar.</p>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="skill-group">
                    <div class="skill-header"><span>Analisis Logika & Sains</span><span>85%</span></div>
            ...
            <div class="card">
                ...
                <p class="text-content">
                    Saya sangat tertarik dengan seni visual digital. Mulai dari mengedit video secara dinamis menggunakan <strong>CapCut</strong>, melakukan manipulasi foto (photo editing), hingga merancang *prompt* kompleks untuk menciptakan gambar AI bernuansa sinematik yang memukau.
                </p>
                
                <div class="art-tags">
                    <span class="art-tag"><i class="fas fa-cut"></i> CapCut Editor</span>
                    <span class="art-tag"><i class="fas fa-magic"></i> Photo Manipulation</span>
                    <span class="art-tag"><i class="fas fa-robot"></i> AI Cinematic Arts</span>
                </div>

                <div style="margin: 25px 0 15px 0; border-top: 1px solid var(--border-gray); padding-top: 20px;">
                    <strong style="font-size: 14px;">Karya Terbaru di YouTube:</strong>
                </div>
                ...
                <a href="https://youtube.com/@dwzz_zz?si=VUzuuWi2W8dYN0_y" target="_blank" class="btn-contact btn-yt" style="margin-top: 15px;">
            ...
            <div class="card">
                ...
                <p class="text-content">Di waktu senggang, game adalah tempat saya melatih strategi, refleks, dan berjejaring dengan teman-teman di dunia maya.</p>
            ...
            <div class="card">
                ...
                <p class="text-content" style="text-align: center;">Mencari teman mabar, diskusi soal sains, atau mengobrol seputar program OSIS? Jangan ragu untuk menghubungi saya!</p>
